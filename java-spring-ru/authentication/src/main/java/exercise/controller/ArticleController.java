...
public class ArticleController {
    ...
    ArticleDTO create(@RequestBody @Valid ArticleCreateDTO dto) throws ResponseStatusException {
//        if (userUtils.getCurrentUser() == null) {
//            throw new ResponseStatusException(HttpStatus.UNAUTHORIZED, "Authorize to create article");
//        }
